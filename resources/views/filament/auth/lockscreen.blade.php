<x-filament-panels::page.simple>
    ...
    <div style="text-align: center; margin-bottom: 1.25rem; display: flex; flex-direction: column; align-items: center;">
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400" style="margin-top: 0.25rem; margin-bottom: 0;">
    ...
    <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; margin-bottom: 0.75rem;">
        ...
        <div class="mt-2 inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-medium bg-amber-500/10 text-amber-700 dark:text-amber-400 border border-amber-500/20" style="margin-top: 0.5rem; display: inline-flex; align-items: center; gap: 0.25rem; padding: 0.25rem 0.75rem; border-radius: 9999px; font-size: 0.75rem;">
            <x-filament::icon icon="heroicon-m-clock" style="width: 14px; height: 14px;" />
            <span>Terkunci karena inaktivitas</span>
        </div>
    </div>
    ...
    <form wire:submit="authenticate" class="space-y-6 mt-4">
        ...
        <div style="margin-top: 1.25rem; display: flex; flex-direction: column; gap: 0.75rem;">
            ...
            >
                <span wire:loading.remove>Buka Kunci</span>
